...
= {
    ...
    // Python: from math import sin, pi; [int(sin(x/128.0*pi)**4*255) for x in range(128)]
    ...
    // Sinesoid
    // Python: from math import cos, pi; [int(round(255*(cos((1+2*x/127.0)*pi)/2+0.5))) for x in range(128)]
    ...
    // Sawtooth
    // Python: [int(round(255*x/127)) for x in range(128)]
    ...
    // Triangular Wave
    // Python: [int(round(255*min(x,128-x)/64)) for x in range(128)]
    ...
    // Trapezoidal Wave
    // Python: [int(round(255*min(1.0,max(0.0,min(x,128-x)/32-0.5)))) for x in range(128)]
